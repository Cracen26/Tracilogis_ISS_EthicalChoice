 ...
 *
 */
public class TracilogisEnv2 extends DefaultEnvironment {
	...
	ArrayList<Integer> fireEmegPlansSeverity = new ArrayList<Integer>();
	...
	//	addPercept("as0",unblocked);
		...
		ethicalRule3.addTerm(new NumberTermImpl(3));
...
//		consultPercept("iss");
		...
		fireEmegPlansSeverity.add(0,0);
		fireEmegPlansSeverity.add(1,0);
		fireEmegPlansSeverity.add(2,0);
		fireEmegPlansSeverity.add(3,0);
		fireEmegPlansSeverity.add(4,0);
		fireEmegPlansSeverity.add(5,0);
